...
@Configuration
@EnableCassandraRepositories(basePackages = "com.hivemind.post.repository")
public class CassandraConfig extends AbstractCassandraConfiguration
{
    @Value("${spring.cassandra.keyspace-name:post_keyspace}")
    ...
    @Override
    public String[] getEntityBasePackages() { return new String[]{"com.hivemind.post.entity"}; }
